      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{url ('/admin/edit-category/'.$categoryDetails->id) }}" name="edit_category" id="edit_category" novalidate="novalidate" enctype="multipart/form-data">
            	@csrf
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <img src="{{asset('data_file/'.$categoryDetails->photo)}}" width="100px" height="100px">
